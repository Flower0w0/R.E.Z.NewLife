...
@ComponentScan({ "_00_init", "_01_register", "_02_login", "_03_raiders", 
	"_04_shop", "_05_shoppingCart", "_06_orderProcess", "_07_love" })
...
//	@PostConstruct
    ...
    public void addInterceptors(InterceptorRegistry registry) {
	    ...
	    registry.addWebRequestInterceptor(openSessionInViewInterceptor)
	    		.addPathPatterns("/_06_orderProcess/orderDetail");
    }
}