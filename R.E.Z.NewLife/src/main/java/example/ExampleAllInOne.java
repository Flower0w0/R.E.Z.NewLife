...
//		System.out.println("aioCheckOutWebATM: " + genAioCheckOutWebATM());
	...
	public static String genAioCheckOutALL(Integer id, String subtotal){
		  UUID uid = UUID.randomUUID();
		  SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
		  String str = sdf.format(new Timestamp(System.currentTimeMillis()));
		  AioCheckOutALL obj = new AioCheckOutALL();
		  obj.setMerchantTradeNo((id).toString() + uid.toString().replaceAll("-", "").substring(0, 12));
		  obj.setMerchantTradeDate(str);
		  obj.setTotalAmount(subtotal);
		  obj.setTradeDesc("test Description");
		  obj.setItemName("R.E.Z.新生訂單");
		  obj.setReturnURL("http://211.23.128.214:5000");
		  obj.setOrderResultURL("http://localhost:8080/R.E.Z.NewLife/_05_shoppingCart/ThanksForOrdering/" + id); //付款完，跳轉到哪個頁面
		  obj.setNeedExtraPaidInfo("N");
		  String form = all.aioCheckOut(obj, null);
		  return form;
		 }
