...
<body
	background="<c:url value='/_04_shop/getOldBgpicture/${product.id}' />"
		...
		<div id="id_content">
			<div>
				...
				<div class="cart_icon">
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb" style="margin: 8px 0;">
								...
								<li class="breadcrumb-item"><a style="font-size: 1rem;"
									href="<c:url value='/_04_shop/OldProducts' />">商品區</a></li>
					...
					<div class="loveshopping">
						<a id="love" href="<c:url value='/_07_love/loveContent' />"><i
							...
							href="<c:url value='/_05_shoppingCart/ShowCartContent' />" id="shopping"><i
				...
				<div class="product_detail">
					<div class="main_img">
						<img src="<c:url value='/_04_shop/getOldPicture/${product.id}' />"
							style="position: absolute; height: auto; width: 30.4%;">
						<img src="<c:url value='/images/others/secondhand.png' />"
                                                     style="position: relative; height: auto; width: 80%;">
					</div>
					<div class="game_title" style="height: auto; width: 100%;">
						...
						<c:forEach varStatus="stVar" var="entry" items="${copy}">
							...
							<h2 class="product_price">
								<span style="font-size: medium;">二手價 </span> <strong
                   ...
                   -->
									...
									<FORM action="<c:url value='/_04_shop/OldProducts.do' />"
										method="POST" style="color: #fff;display: inline-block; margin-right: 20px;">
										購買數量 <select class="stock" name='count' style="margin: 0 20px 0 20px;">
										</select>
										<!-- 這些隱藏欄位都會送到後端 -->
							...
							<FORM action="<c:url value='/_07_love/OldLove.do' />" method="POST"
