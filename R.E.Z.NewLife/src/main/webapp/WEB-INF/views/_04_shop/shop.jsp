								...
								<ul class="pagination justify-content-center"
									...
									<c:if test="${pageNo > 1}">
										<li class="page-item"><a class="page-link"
											id="pagenoprev"
											href="<c:url value='/_04_shop/NewProducts?pageNo=${pageNo-1}' />"
											aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
										</a></li>
									</c:if>
									<li class="page-item"><a class="page-link"
										href="<c:url value='/_04_shop/NewProducts?pageNo=1' />">第${pageNo}頁
											/ 共${totalPages}頁</a></li>
						...
						<div class="tab-pane fade" id="ps_product" role="tabpanel"
							...
							<div class="contanier">
								<div class="row">
									...
									<c:forEach varStatus="stVar" var="entry"
										items="${Sonyproducts_DPP}">
										<div class="col-md-3" style="margin-bottom: 2%;">
											<div class="card" style="width: 100%;">
												<a href="<c:url value='/_04_shop/Newproduct?id=${entry.value.id}' />"> <img
													src="<c:url value='/_00_init/getGameImage?id=${entry.value.id}' />"
													class="card-img-top" alt="...">
												</a>
												<div class="card-body" style="text-align: left;">
													<p class="card-text"
														style="display: flex; justify-content: center;">
														<span><img width="16%" style="float: left;"
															src="<c:url value='/_00_init/getLevelImage?id=${entry.value.id}' />"
															alt=""><img width="25%" style="float: right;"
															src="<c:url value='/_00_init/getCnImage?id=${entry.value.id}' />"
															alt=""></span>
													</p>
												</div>
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center"
									...
									<c:if test="${SpageNo > 1}">
										<li class="page-item"><a class="page-link"
											id="spagenoprev"
											href="<c:url value='/_04_shop/NewProducts?SpageNo=${SpageNo-1}' />"
											aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
										</a></li>
									</c:if>
									<li class="page-item"><a class="page-link"
										href="<c:url value='/_04_shop/NewProducts?SpageNo=1' />">第${SpageNo}頁
											/ 共${StotalPages}頁</a></li>
									<c:if test="${SpageNo != StotalPages}">
										<li class="page-item"><a class="page-link"
											id="spagenonext"
											href="<c:url value='/_04_shop/NewProducts?SpageNo=${SpageNo+1}' />"
											aria-label="Next"> <span aria-hidden="true">&raquo;</span>
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center"
									...
									<c:if test="${NpageNo > 1}">
										<li class="page-item"><a class="page-link"
											id="spagenoprev"
											href="<c:url value='/_04_shop/NewProducts?NpageNo=${NpageNo-1}' />"
											aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
										</a></li>
									</c:if>
									<li class="page-item"><a class="page-link"
										href="<c:url value='/_04_shop/NewProducts?NpageNo=1' />">第${NpageNo}頁
											/ 共${NtotalPages}頁</a></li>
									<c:if test="${NpageNo != NtotalPages}">
										<li class="page-item"><a class="page-link"
											id="npagenonext"
											href="<c:url value='/_04_shop/NewProducts?NpageNo=${NpageNo+1}' />"
											aria-label="Next"> <span aria-hidden="true">&raquo;</span>
