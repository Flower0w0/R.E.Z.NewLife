		...
		<div>
			...
			<div id="id_content">
				...
				<div class="forget-center">
					<FORM action="<c:url value='/_01_register/updatepwd' />"
						method="POST">
						<input type="hidden" value="${param.token}" name="token" />
						<Table class="forget">
							<tr height="36">
							<td class="joinus" colspan='4'>重置密碼</td>
							</tr>
							
							<tr>
							<td><span>${updatepwdMSG}</span></td>
							</tr>
							
							<tr height="52">
								<td><input type="password" name="password"
									placeholder="請重新設置密碼" /></td>
							</tr>
							<tr>
								<td><input type="password" name="password1"
									placeholder="請再次輸入密碼" /></td>
							</tr>

							<tr height="52">
								<td><input type="submit" value="確認重置" /></td>
							</tr>
						</Table>
					</FORM>
				</div>
